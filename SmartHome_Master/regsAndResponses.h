...
#ifndef REGSANDRESPONSES_H_
#define REGSANDRESPONSES_H_
#define EEPROM_FIXED_ADDRESS 0b1010000
	...
	#define SFIOR		*((volatile unsigned char*)0x50)					// special Function Register
	#define ADTS2		7
	...
	#define OCR0_REG			*((volatile unsigned char*)0x5C)			/*Output compare match register*/
	#define TCNT0_REG           *((volatile unsigned char*)0x52)			/*Timer counter 0 register*/
	#define TIFR0_REG			*((volatile unsigned char*)0x58)

	#define TIMSK_REG			*((volatile unsigned char*)0x59)			/*Timer mask register*/
	...
	#define TCCR1A_REG   *((volatile unsigned char*)0x4F)    /*Timer1 Control registerA*/
	...
	#define UDR_REG		*((volatile unsigned char*)0x2C)

	#define UCSRA_REG	*((volatile unsigned char*)0x2B)
	...
	#define UCSRB_REG	*((volatile unsigned char*)0x2A)

	#define UCSRB_RXEN	4
	#define UCSRB_TXEN	3
	#define UCSRB_UCSZ2	2

	#define UBRRL_REG	*((volatile unsigned char*)0x29)
	#define UBRRH_REG	*((volatile unsigned char*)0x40)
	...
	#define UCSRC_REG	*((volatile unsigned char*)0x40)            // its the same reg of UBRRH
	...
	/*                        TWI REG                                       */
	/************************************************************************/
	#define TWCR_REG	*((volatile unsigned char*)0x56) /*TWI Control Register*/
	...
	#define TWDR_REG	*((volatile unsigned char*)0x23)	/*TWI Data Register*/

	#define TWAR_REG	*((volatile unsigned char*)0x22)	/*TWI Address Register*/
	#define TWAR_TWGCE	0							/*General Call recognition Enable*/

	#define TWSR_REG	*((volatile unsigned char*)0x21)	/*TWI Status Register*/
	#define TWSR_TWPS0	0							/*Prescaler Bit0*/
	#define TWSR_TWPS1	1							/*Prescaler Bit1*/

	#define TWBR_REG	*((volatile unsigned char*)0x20)	/*TWI Bit Rate Register*/
...
#define SLAVE_BYTE_TRANSIMITTED


#endif /* REGSANDRESPONSES_H_ */
